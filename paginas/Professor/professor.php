<section id="inicio">
			...
			<!--Corpo da Página-->
				<div class="row">
					...
					<div class="col-lg-3">
						...
						<div class="panel panel-red">
							...
							<a href="http://200.145.153.172/quarkz/Quimicamente/paginas/todosconteudos.php">
								<div class="panel-footer">
				...
				<div class="row"> 
					<div class="col-lg-12">
						<div class="panel panel-default">
							...
							<div class="panel-body" id="conteudos">
							...
							<div id="conteudos-pagination" class="text-center" style="display: none">
									<a id="conteudos-previous" href="#" class="b">&laquo; Previous</a> 
									<a id="conteudos-next" href="#" class="b">Next &raquo;</a>
							</div>
							<div class="panel-footer">
				...
				<script>
					...
					$('#conteudos').paginate({ itemsPerPage: 4 });
				</script>
		</div><!--container-fluid-->
