		<fieldset>
					...
					<div class="form-group">
						&nbsp;
						<div id="mini">
							<input type="text" id="dtnas" placeholder="Nascimento" maxlength="10" onkeypress="mascaraData( this, event ); return numeros();" class="f1-last-name form-control" data-toggle="tooltip" data-placement="bottom" title="Insira sua data de Nascimento">
						</div>
						<div id="medium">
							<input type="text" placeholder="RA" maxlength="11" onkeypress="return numeros();" class="f1-last-name form-control" id="ra" name="ra" data-toggle="tooltip" data-placement="bottom" title="Insira seu RA"/>
						</div>
						<br>&nbsp;
					</div>
