		<fieldset>
					...
					<div class="form-group">
						...
						<div id="medium">
							<input type="text" placeholder="CPF" maxlength="11" onkeypress="return numeros();" class="f1-last-name form-control" id="cpf" name="cpf" data-toggle="tooltip" data-placement="bottom" title="Insira seu CPF"/>
						</div>
						<br>&nbsp;
					</div>
